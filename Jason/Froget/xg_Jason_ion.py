...
The cleaned observations are split deterministically by day of year (DOY) into
...
sampling. Optuna sees only training and validation data; the test set remains
untouched until the selected model is evaluated.
"""
...
def main() -> int:
    ...
    indices = split_by_day_of_year(data_sorted)
